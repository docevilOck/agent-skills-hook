---
name: ddev-spec
description: 【禁止自动加载 — 不可被「技能强制评估」自动匹配】仅限用户手动调用。用于代码修改前编写 spec 文档，优先用图表达边界、入口、流程和改动关系（仅限代码改动场景，非项目级架构文档初始化）。
---
...
| 类型 | 对象 | 说明 |
|------|------|------|
| ADDED | `usb_hid_report_ctx_t` | 新增上下文结构体，管理 HID report 生命周期 |
| ADDED | `src/usb/usb_hid.c` | 新增 HID 类驱动实现文件 |
