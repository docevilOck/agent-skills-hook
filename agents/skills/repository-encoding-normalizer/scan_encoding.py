...
def is_chinese_char(ch):
    ...
    return (
        ...
        or (0x00B0 <= cp <= 0x00B0)   # ° degree sign
        or (0x2013 <= cp <= 0x2014)   # – — dashes
        or (0x2018 <= cp <= 0x2019)   # ' ' single quotes
        or (0x201C <= cp <= 0x201D)   # " " double quotes
        or (0x2026 <= cp <= 0x2026)   # … ellipsis
        or (0x00D7 <= cp <= 0x00D7)   # × multiplication
        or (0x00F7 <= cp <= 0x00F7)   # ÷ division
    )
